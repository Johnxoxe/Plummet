...
draw_text(DisplayW *.35, DisplayH *.3, ".3");
draw_text(DisplayW *.45, DisplayH *.4, ".4");
draw_text(DisplayW *.55, DisplayH *.5, ".5");
draw_text(DisplayW *.65, DisplayH *.6, ".6");
draw_text(DisplayW *.75, DisplayH *.7, ".7");
draw_text(DisplayW *.85, DisplayH *.8, ".8");
